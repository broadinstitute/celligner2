...
- 🎯 Entry points to execute your program using `python -m <celligner2>` or `$ celligner2` with basic CLI argument parsing.
...
Awesome celligner2 created by broadinstitute
